...
namespace FastColoredTextBoxNS
{
    ...
    public struct LineInfo
    {
        ...
        public int GetWordWrapStringFinishPosition(int iWordWrapLine, Line line)
        {
        ...
        /// </summary>
        public void CalcCutOffs(int maxCharsPerLine, bool allowIME, bool charWrap, Line line)
        {
            int segmentLength = 0;
            int cutOff = 0;
